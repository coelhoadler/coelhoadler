...
const translations = {
    pt: {
        ...
        themeLabel: 'Tema',
        heroTitle: 'Olá, eu sou <strong class="dark:text-[#4f46e5] efeito-escrita font-mono">Adler</strong><span class="piscar dark:text-[#4f46e5]">_</span>',
    ...
    en: {
        ...
        themeLabel: 'Theme',
        heroTitle: 'Hi, I\'m <strong class="dark:text-[#4f46e5] efeito-escrita font-mono">Adler</strong><span class="piscar dark:text-[#4f46e5]">_</span>',
